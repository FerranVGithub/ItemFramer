...
#lock item frames rotation
execute at @e[type=minecraft:interaction,nbt={Tags:["itemframer:interaction"],attack:{},}] as @n[type=glow_item_frame,distance=..0.5,nbt={Fixed:false, Item:{}}] run function itemframer:glow_itemframes/lock with entity @s

#Unlock item frames rotation
execute at @e[type=minecraft:interaction,nbt={Tags:["itemframer:interaction"],attack:{}}] as @n[type=glow_item_frame,distance=..0.5,nbt={Fixed:true, Item:{}}] run function itemframer:glow_itemframes/unlock with entity @s
